...
namespace PIMTool.Test.Generator
{
    public class ProjectDataGenerator
    {
        ...
        public ProjectEntity InitProject(string projectName, GroupEntity group)
        {
        ...
        public ProjectEntity GetByProjectNumber(int projectNumber)
        {
            ProjectEntity result;
            using (var scope = UnitOfWorkProvider.Provide())
            {
                result = ProjectRepository.GetProjectByProjectNumber(projectNumber);
            }
